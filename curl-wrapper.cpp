...
{
#ifndef _NDEBUG
    static_assert(sizeof(CurlEasy::m_ErrorBuffer) >= CURL_ERROR_SIZE, "CurlEasy::m_ErrorBuffer must be at least CURL_ERROR_SIZE big. (See https://curl.haxx.se/libcurl/c/CURLOPT_ERRORBUFFER.html)");
#endif
